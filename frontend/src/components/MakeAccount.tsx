                ...
                <div className="hidden lg:flex h-full w-full justify-center items-center">
                    <form className="w-full max-w-lg py-3 px-5 bg-gray-100 rounded ">
                        ...
                        <div className="flex flex-wrap -mx-3 mb-6å">
                            ...
                            <div className="w-full px-3">
                                <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Select an option</label>
                                <select className="bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500
