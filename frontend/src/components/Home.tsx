    ...
    <section className="h-screen pt-16">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-[32%_36%_32%] 3xl:grid-cols-[1fr_691px_1fr] h-screen-adjusted">
        ...
        >
          {messages.map((msg, index) =>
            msg.sender_name === username ? (
              <div className="grid grid-cols-2">
                ...
                >
                  {msg.content} <br></br> <p className="text-gray-600 text-right">Sent on {msg.timestamp}</p>
                </div>
              </div>
            ) : (
              <div className="grid grid-cols-2">
                ...
                >
                  {msg.content} <br></br> <span className="text-gray-600">Sent on {msg.timestamp}</span>
                </div>
                <div></div>
              </div>
            )
          ...
          <footer className="flex mt-auto w-full justify-items-center text-center items-center">
            {}
            <form onSubmit={handleSubmit} className="w-full flex">
              <input
                type="text"
                id="message_tag"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 ml-2 mb-2 mr-2"
                placeholder="Message"
                required
                value={messageText}
              ...
              <button
                type="submit"
                className="text-white bg-blue-200 hover:bg-blue-500 font-medium rounded text-sm w-1/4 px-5 py-2.5 mr-3 mb-2 text-center"
              >
                Send
              </button>
            </form>
