...
function ResetPassword() {
    ...
    return (
        <section className="bg-blue-100 h-screen">
            <div >
                <div className="min-h-screen flex h-full w-full justify-center items-center">
                    <form
                        ref={formRef}
                    ...
                    >
                        <div className="flex flex-col pb-2">
                            <h1 className="text-4xl lg:text-left md:text-left text-center font-semibold">Reset Password</h1>
                        </div>
